...
if [ "${DEPLOY:-0}" == "1" ]; then
  ...
  for required_secret in COVERLETTER_GEMINI_TOKEN COVERLETTER_ADMIN_PASSWORD COVERLETTER_AUTH_USERS_JSON COVERLETTER_ADMIN_JWT_SECRET COVERLETTER_JWT_SECRET COVERLETTER_SERPER_API_KEY; do
