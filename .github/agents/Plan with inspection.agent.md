...
You can inspect runtime state while planning by:
- Navigating to http://localhost/ to view the application UI.
- Navigating to http://mongo-express/ to inspect MongoDB data and understand data structures.
- Running `docker container logs lib-<service_name>` (for example: `docker container logs lib-crawler-hackernews-1`) to inspect service logs.
